...
def clean_bengaluru_rentals(raw_path: Path = RAW_DATA_PATH) -> tuple[pd.DataFrame, dict[str, int]]:
    ...
    bengaluru["area_rate_difference"] = bengaluru["rent_per_sqft"] - bengaluru["area_rate"]
    bengaluru["area_rate_pct_difference"] = (
        bengaluru["area_rate_difference"] / bengaluru["rent_per_sqft"]
    ).abs()
    ...
    numeric_columns = ["area", "area_rate", "rent", "rent_per_sqft", "area_rate_difference", "area_rate_pct_difference"]
    ...
    columns = [
        ...
        "rent",
        "rent_per_sqft",
        "area_rate_difference",
        "area_rate_pct_difference",
    ]
...
def main() -> None:
    ...
    print(clean_df[["rent_per_sqft", "area_rate", "area_rate_difference"]].describe().round(2))
